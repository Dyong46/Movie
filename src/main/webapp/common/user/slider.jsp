         ...
         <div class="slider-inner h-100">
            <div class="row align-items-center  h-100">
               <div class="col-xl-6 col-lg-12 col-md-12">
                  ...
                  <p data-animation-in="fadeInUp" data-delay-in="0.7">Lorem Ipsum is simply dummy text of the
         ...
         <div class="slider-inner h-100">
            <div class="row align-items-center  h-100">
               <div class="col-xl-6 col-lg-12 col-md-12">
                  ...
                  <h1 class="slider-text big-title title text-uppercase" data-animation-in="fadeInLeft">sail
                     coaster</h1>
         ...
         <div class="slider-inner h-100">
            <div class="row align-items-center  h-100">
               <div class="col-xl-6 col-lg-12 col-md-12">
                  ...
                  <h1 class="slider-text big-title title text-uppercase" data-animation-in="fadeInLeft">the army
                  </h1>
                  ...
                  <p data-animation-in="fadeInUp" data-delay-in="1.2" class="fadeInUp animated"
                     style="opacity: 1; animation-delay: 1.2s;">Lorem Ipsum is simply dummy text of the printing
