...
@WebServlet({ "/login", "/logout", "/register", "/forgotPass", "/edit-profile" })
public class UserController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "/forgotPass":
			...
			break;
		case "/edit-profile":
			doGetEditProfile(session, req, resp);
			break;
		case "/change-pass":
			doGetEditProfile(session, req, resp);
			break;
	...
	private void doGetEditProfile(HttpSession session, HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
	...
	private void doPostEditProfile(HttpSession session, HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			User userEdit = userService.update(user);
			if(userEdit != null) {
				session.setAttribute(SessionAttr.CURRENT_USER, userEdit);
				req.setAttribute("message", "Update profile successful!");
				resp.sendRedirect("index");
			} else {
				req.setAttribute("message", "Update profile fail!");
